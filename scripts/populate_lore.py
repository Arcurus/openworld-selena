...
from lore_data import (
    ...
    GREENMARK_FARM,
    THE_WANDERERS_REST,
    THE_SILVERLEAF_SANCTUARY,
    THE_SUNKEN_TEMPLE,
    THE_DAWNWATCH_LIGHTHOUSE,
    THE_WRECK_OF_THE_BLACK_SAILS,
    THE_HOWLING_RAVINE,
    THE_BONE_ORCHARD,
    OAK_VALLEY_VILLAGE,
    THE_WITCHFEN,
    PINEGROVE_LOGGING_CAMP,
    THE_BLEAKMOOR,
)
...
LORE_TO_ENTITY_NAME = {
    ...
    "THE_STONEBRIDGE": "The Stonebridge",
    "SALTCLIFF_COVE": "Saltcliff Cove",
    "THE_OLD_BATTLEFIELD": "The Old Battlefield",
    "HOLLOWMERE_VILLAGE": "Hollowmere Village",
    "BRACKENHOLD_MINE": "Brackenhold Mine",
    "SHADOW_RIDGE_CAMP": "Shadow Ridge Camp",
    "THE_HOLLOW_CRYPT": "The Hollow Crypt",
    "CROSSROADS_MARKET": "Crossroads Market",
    "WILLOWFEN_MARSH": "Willowfen Marsh",
    "GREENMARK_FARM": "Greenmark Farm",
    "THE_WANDERERS_REST": "The Wanderer's Rest",
    "THE_SILVERLEAF_SANCTUARY": "The Silverleaf Sanctuary",
    "THE_SUNKEN_TEMPLE": "The Sunken Temple",
    "THE_DAWNWATCH_LIGHTHOUSE": "The Dawnwatch Lighthouse",
    "THE_WRECK_OF_THE_BLACK_SAILS": "The Wreck of the Black Sails",
    "THE_HOWLING_RAVINE": "The Howling Ravine",
    "THE_BONE_ORCHARD": "The Bone Orchard",
    "OAK_VALLEY_VILLAGE": "Oak Valley Village",
    "THE_WITCHFEN": "The Witchfen",
    "PINEGROVE_LOGGING_CAMP": "Pinegrove Logging Camp",
    "THE_BLEAKMOOR": "The Bleakmoor",
}
...
LORE_DATA_BY_VAR = {
    ...
    "THE_STONEBRIDGE": THE_STONEBRIDGE,
    "SALTCLIFF_COVE": SALTCLIFF_COVE,
    "THE_OLD_BATTLEFIELD": THE_OLD_BATTLEFIELD,
    "HOLLOWMERE_VILLAGE": HOLLOWMERE_VILLAGE,
    "BRACKENHOLD_MINE": BRACKENHOLD_MINE,
    "SHADOW_RIDGE_CAMP": SHADOW_RIDGE_CAMP,
    "THE_HOLLOW_CRYPT": THE_HOLLOW_CRYPT,
    "CROSSROADS_MARKET": CROSSROADS_MARKET,
    "WILLOWFEN_MARSH": WILLOWFEN_MARSH,
    "GREENMARK_FARM": GREENMARK_FARM,
    "THE_WANDERERS_REST": THE_WANDERERS_REST,
    "THE_SILVERLEAF_SANCTUARY": THE_SILVERLEAF_SANCTUARY,
    "THE_SUNKEN_TEMPLE": THE_SUNKEN_TEMPLE,
    "THE_DAWNWATCH_LIGHTHOUSE": THE_DAWNWATCH_LIGHTHOUSE,
    "THE_WRECK_OF_THE_BLACK_SAILS": THE_WRECK_OF_THE_BLACK_SAILS,
    "THE_HOWLING_RAVINE": THE_HOWLING_RAVINE,
    "THE_BONE_ORCHARD": THE_BONE_ORCHARD,
    "OAK_VALLEY_VILLAGE": OAK_VALLEY_VILLAGE,
    "THE_WITCHFEN": THE_WITCHFEN,
    "PINEGROVE_LOGGING_CAMP": PINEGROVE_LOGGING_CAMP,
    "THE_BLEAKMOOR": THE_BLEAKMOOR,
}
